...
<body class="g-sidenav-show bg-gray-200">
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white" href="{{route('painel')}}">
              ...
              <div class="card bg-transparent shadow-xl">
                <div class="overflow-hidden position-relative border-radius-xl">
                  ...
                  <div class="card-body position-relative z-index-1 p-3">
                    ...
                    <h5 class="text-white mt-4 mb-5 pb-2"> &nbsp;&nbsp;&nbsp;0000&nbsp;&nbsp;&nbsp;0000&nbsp;&nbsp;&nbsp;0000</h5>
                    <div class="d-flex">
                      <div class="d-flex">
                        <div class="me-4">
                          <p class="text-white text-sm opacity-8 mb-0">CVV</p>
                          <h6 class="text-white mb-0">Usuário </h6>
                        </div>
                        <div>
                          <p class="text-white text-sm opacity-8 mb-0">Data validade</p>
                          <h6 class="text-white mb-0">00/22</h6>
                        </div>
                      </div>
                      <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                        <img class="w-60 mt-2" src="img/logo.png" alt="logo">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Pix</h6>
                      <span class="text-xs">Para confirmar o pagamento espere a mensagem de aprovação</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">NPixAqui</h5>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    <div class="col-6 d-flex align-items-center">
                      <h6 class="mb-0">Cartão</h6>
                    </div>
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-success mb-0" href="javascript:;"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Pagar agora</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <img class="w-10 me-3 mb-0" src="img/logo.png" alt="logo">
                        <h6 class="mb-0">****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;****</h6>
                        <i class="material-icons ms-auto text-dark cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Adicionar cartão">add</i>
                      </div>
                    </div>
        ...
        <div class="col-lg-4">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                <div class="col-6 d-flex align-items-center">
                  <h6 class="mb-0">Processamento</h6>
                </div>
                {{-- <div class="col-6 text-end">
                  <button class="btn btn-outline-primary btn-sm mb-0">P</button>
                </div> --}}
              </div>
            </div>
              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-1 text-success font-weight-bold text-sm">Aprovado</h6>
